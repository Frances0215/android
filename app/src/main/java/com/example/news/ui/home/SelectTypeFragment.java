...
public class SelectTypeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout layoutroot = new RelativeLayout(getActivity());
        layoutroot.setLayoutParams(layoutParamsroot);

        //得到一些全局变量,得到所有的type和我的type
        NewsAPP myAPP = (NewsAPP) getActivity().getApplicationContext();
        ...
        TextView mTvMyType = new TextView(getActivity());
        ...
        if (otherType.size() > 0) {
            ...
            TextView mTvOtherType = new TextView(getActivity());
        ...
        getActivity().setContentView(layoutroot);
